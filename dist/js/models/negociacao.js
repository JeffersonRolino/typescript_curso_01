...
var _Negociacao_data, _Negociacao_quantidade, _Negociacao_valor, _Negociacao_volume;
export class Negociacao {
    constructor(data, quantidade, valor) {
        _Negociacao_data.set(this, void 0);
        _Negociacao_quantidade.set(this, void 0);
        _Negociacao_valor.set(this, void 0);
        _Negociacao_volume.set(this, void 0);
        ...
        __classPrivateFieldSet(this, _Negociacao_volume, __classPrivateFieldGet(this, _Negociacao_quantidade, "f") * __classPrivateFieldGet(this, _Negociacao_valor, "f"), "f");
    }
    get data() {
...
_Negociacao_data = new WeakMap(), _Negociacao_quantidade = new WeakMap(), _Negociacao_valor = new WeakMap(), _Negociacao_volume = new WeakMap();
